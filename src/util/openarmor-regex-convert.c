...
#undef ARGV0
#define ARGV0 "openarmor-regex-convert"
...
{
    printf("\n"
           "openarmor HIDS %s: openarmor-regex-convert -h\n"
           "openarmor HIDS %s: openarmor-regex-convert -t\n"
           "openarmor HIDS %s: openarmor-regex-convert [-mr] PATTERN [PATTERN...]\n"
           "openarmor HIDS %s: openarmor-regex-convert -b TAG PATTERN [TAG PATTERN...]\n"
