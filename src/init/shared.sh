...
openarmor_INIT="/etc/openarmor-init.conf"
HOST=`hostname`
...
## Host output
openarmorMX="devmail.theopenarmor.org mail is handled by 10 openarmor.mooo.com."
openarmorMX2="devmail.theopenarmor.org mail is handled (pri=10) by openarmor.mooo.com"
openarmorMX3="devmail.theopenarmor.org mail is handled by 10 openarmor.mooo.COM."
