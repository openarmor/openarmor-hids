...
int main(int argc, char **argv)
{
    ...
    if (mond.reports) {
        ...
        const char *(xml_smtp[]) = {"openarmor_config", "global", "smtp_server", NULL};
        const char *(xml_from[]) = {"openarmor_config", "global", "email_from", NULL};
        const char *(xml_idsname[]) = {"openarmor_config", "global", "email_idsname", NULL};
