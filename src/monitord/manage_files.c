...
void manage_files(int cday, int cmon, int cyear)
{
    ...
    /* Event logfile */
    snprintf(elogfile, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.log",
             EVENTS,
             cyear,
             months[cmon],
             "archive",
             cday);
    /* Event log file old */
    snprintf(elogfile_old, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.log",
             EVENTS,
             pp_old->tm_year + 1900,
    ...
    /* JSON Event logfile */
    snprintf(ejlogfile, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.json",
             EVENTS,
             cyear,
             months[cmon],
             "archive",
    ...
    snprintf(ejlogfile_old, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.json",
             EVENTS,
             pp_old->tm_year + 1900,
             months[pp_old->tm_mon],
             "archive",
    ...
    /* alert logfile  */
    snprintf(alogfile, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.log",
             ALERTS,
             cyear,
             months[cmon],
             "alerts",
             cday);
    /* alert logfile old  */
    snprintf(alogfile_old, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.log",
             ALERTS,
             pp_old->tm_year + 1900,
             months[pp_old->tm_mon],
             "alerts",
    ...
    /* alert logfile  */
    snprintf(ajlogfile, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.json",
             ALERTS,
             cyear,
             months[cmon],
             "alerts",
             cday);
    /* alert logfile old  */
    snprintf(ajlogfile_old, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.json",
             ALERTS,
             pp_old->tm_year + 1900,
             months[pp_old->tm_mon],
             "alerts",
    ...
    /* firewall events */
    snprintf(flogfile, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.log",
             FWLOGS,
             cyear,
             months[cmon],
             "firewall",
             cday);
    /* firewall events old */
    snprintf(flogfile_old, OS_FLSIZE, "%s/%d/%s/openarmor-%s-%02d.log",
             FWLOGS,
             pp_old->tm_year + 1900,
             months[pp_old->tm_mon],
             "firewall",
