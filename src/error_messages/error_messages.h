...
#define DB_COMPILED     "%s(5207): ERROR: openarmor not compiled with support for '%s'."
...
/* openarmor alert messages */
#define OS_AD_STARTED   "openarmor: openarmor started."
#define OS_AG_STARTED   "openarmor: Agent started: '%s->%s'."
#define OS_AG_DISCON    "openarmor: Agent disconnected: '%s'."
