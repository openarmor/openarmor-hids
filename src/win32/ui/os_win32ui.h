...
/* Default values */
#define CONFIG          "openarmor.conf"
#define LASTCONFIG      "last-openarmor.conf"
#define VERSION_FILE    "VERSION.txt"
#define openarmorLOGS       "openarmor.log"
#define HELPTXT         "help.txt"
#define SENDER_FILE     "rids\\sender_counter"
#define DEFDIR          "C:\\Program Files\\openarmor-agent"
...
#define ST_MISSING_IMPORT   "Require import of authentication key.\r\n" \
                            "            - Not Running"
#define ST_MISSING_SERVER   "Require openarmor Server IP address.\r\n" \
                            "            - Not Running"
...
/* Global openarmor config structure */
typedef struct _openarmor_config {
