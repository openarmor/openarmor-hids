...
/* Some global names */
#define __openarmor_name    "openarmor HIDS"
#define __openarmor_version "v3.8.0"
#define __author        "openarmor Foundation"
#define __contact       "contact@theopenarmor.org"
#define __site          "https://www.theopenarmor.org"
#define __license       "\
...
/* User Configuration */
#ifndef MAILUSER
#define MAILUSER        "openarmorm"
#endif

#ifndef USER
#define USER            "openarmor"
#endif

#ifndef REMUSER
#define REMUSER         "openarmorr"
#endif

#ifndef GROUPGLOBAL
#define GROUPGLOBAL     "openarmor"
#endif

#ifndef DEFAULTDIR
#define DEFAULTDIR      "/var/openarmor"
#endif

/* Default queue */
#define DEFAULTQUEUE    "/queue/openarmor/queue"
...
/* Wait file */
#ifndef WIN32
#define WAIT_FILE       "/queue/openarmor/.wait"
#else
...
#ifndef WIN32
#define AGENT_INFO_FILE "/queue/openarmor/.agent_info"
...
#ifndef WIN32
#define openarmor_DEFINES   "/etc/internal_options.conf"
#define openarmor_LDEFINES   "/etc/local_internal_options.conf"
#else
#define openarmor_DEFINES   "internal_options.conf"
#define openarmor_LDEFINES   "local_internal_options.conf"
#endif
...
#ifndef WIN32
#define openarmorCONF       "/etc/openarmor.conf"
#define DEFAULTCPATH    DEFAULTDIR openarmorCONF
#else
#define openarmorCONF       "openarmor.conf"
#define DEFAULTCPATH    "openarmor.conf"
#endif
