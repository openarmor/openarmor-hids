...
#define SMS_SUBJECT         "openarmor %d - %d - %s"
#define MAIL_SUBJECT        "openarmor Notification - %s - Alert level %d"
#define MAIL_SUBJECT_FULL   "openarmor Alert - %s - Level %d - %s"

/* Full subject without openarmor in the name */
#ifdef CLEANFULL
