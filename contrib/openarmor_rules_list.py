#!/usr/bin/python
# openarmor Rules list
# Simple script to get a short brief of every rule in openarmor rules folder
...
rules_directory = "/var/openarmor/rules/"
...
def GetRulesList(fulldir, filename):
    ...
    try:
        with open(fulldir) as f:
           ...
           print ("Error: openarmor rules directory does not appear to exist")
