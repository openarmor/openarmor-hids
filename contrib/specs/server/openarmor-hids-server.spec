#
# openarmor 1.3 .spec file - SERVER
...
Name: openarmor-hids-server-FC7
Version: 1.3
Release: 1
License: GPLv2
...
%build
/bin/cp /usr/local/src/openarmor-RPM/1.3/server/preloaded-vars.conf ${RPM_BUILD_DIR}/openarmor-hids-1.3/etc/
